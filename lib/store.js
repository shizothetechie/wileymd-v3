...
/**
 * @type {import('@teamerror/Eaileys')}
 */
const { initAuthCreds, BufferJSON, proto } = (await import('@teamerror/Eaileys')).default

/**
 * @param {import('@teamerror/Eaileys').WASocket | import('@teamerror/Eaileys').WALegacySocket}
 */
function bind(conn) {
    if (!conn.chats) conn.chats = {}
    /**
     * 
     * @param {import('@teamerror/Eaileys').Contact[]|{contacts:import('@teamerror/Eaileys').Contact[]}} contacts 
     * @returns 
     */
